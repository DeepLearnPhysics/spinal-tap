...
- **Unified source entry**: Accept server paths and public URLs through one Path field and show a delayed loading spinner while remote LArCV content is being identified.
